...
hi("WhichKeyNormal", { fg = p.text, bg = p.canvas })
hi("SnacksPickerSelected", { fg = p.deep, bg = p.violet, bold = true })
hi("SnacksPickerListCursorLine", { fg = p.deep, bg = p.violet })
hi("SnacksPickerBorder", { fg = p.violet, bg = p.raised })
hi("SnacksInputBorder", { fg = p.violet, bg = p.raised })
