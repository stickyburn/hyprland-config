...
local function apply()
  ...
  hi("ColorColumn", { bg = lineBg })
  hi("Cursor", { fg = r.background, bg = r.foreground })
  hi("CursorLine", { bg = lineBg })
  ...
  hi("DiagnosticInfo", { fg = r.success })
...
vim.api.nvim_create_user_command("HyprwayToggle", function()
  set(current == "dark" and "light" or "dark")
end, {})
vim.api.nvim_create_user_command("HyprwayLight", function()
  set("light")
end, {})
vim.api.nvim_create_user_command("HyprwayDark", function()
  set("dark")
end, {})
